...
def test_requirements_are_collected(tmp_path: Path):
    ...
    system_reqs = architecture.part_definitions["System"].refs["requirements"]
    signal_reqs = architecture.port_definitions["Signal"].refs["requirements"]
...
def test_requirement_definition_inheritance(tmp_path: Path):
    ...
    req_ref = architecture.part_definitions["System"].refs["requirements"]["REQ_1"]
